...
<div>
    <header class="text-end my-4">
        <a class="btn btn--primary" href="/admin/info-adicional/edades/agregar">
            ...
            <tbody>
                ...
                <tr class="roboto-regular text-center text-lg">
                    ...
                    <td class="flex justify-center py-2">
                        <a href="/admin/info-adicional/catedras/editar/{{ $item->id }}" class="bg-white hover:bg-light_pink transition-all rounded p-2 shadow">
