...
<div>
    ...
    <form action="/admin/info-adicional/como-nos-encontraste/editar/{{$item->id}}" method="POST" id="formAddEncontraste">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-2">
            <input type="text" placeholder="Nombre" name="nombre" class="input" value="{{$item->how}}">
